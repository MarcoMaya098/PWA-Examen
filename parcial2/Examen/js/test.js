...
function getPendingsIds() {
    fetch(url)
        ...
        .then(todos => {
            const pendingIds = todos.map(todo => ({ id: todo.id }));
...
function getPendingsIdsAndTitles() {
    fetch(url)
        .then(response => response.json())
        .then(todos => {
            const pendingIdsAndTitles = todos.map(todo => ({ id: todo.id, title: todo.title }));
...
function getUnresolvedPendings() {
    fetch(url)
        .then(response => response.json())
        .then(todos => {
            const unresolvedPending = todos.filter(todo => !todo.completed)
...
function getResolvedPendings() {
    fetch(url)
        .then(response => response.json())
        .then(todos => {
            const resolvedPending = todos.filter(todo => todo.completed)
                                         .map(todo => ({ id: todo.id, title: todo.title }));
...
function getPendingsWithUserId() {
    fetch(url)
        .then(response => response.json())
        .then(todos => {
            const pendingWithUserId = todos.map(todo => ({ id: todo.id, userId: todo.userId }));
...
function getResolvedPendingsWithUserId() {
    fetch(url)
        .then(response => response.json())
        .then(todos => {
            const resolvedPendingWithUserId = todos.filter(todo => todo.completed)
...
function getUnresolvedPendingsWithUserId() {
    fetch(url)
        .then(response => response.json())
        .then(todos => {
            const unresolvedPendingWithUserId = todos.filter(todo => !todo.completed)
                                                      .map(todo => ({ id: todo.id, userId: todo.userId }));
